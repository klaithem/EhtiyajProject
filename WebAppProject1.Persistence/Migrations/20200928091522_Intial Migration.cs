        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Emp_name_ENG = table.Column<string>(maxLength: 100, nullable: false),
                    JobTitleId = table.Column<int>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pro_initials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pro_initials_Employees_EmployeesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pro_initials_EmployeesId",
                table: "Pro_initials",
                column: "EmployeesId");
        }
